...
JSON.stringify((() => {
  ...
  return {
    ...
    buttons: pick(document.querySelectorAll('[data-testid="tweetButton"], [data-testid="tweetButtonInline"], [data-testid="SideNav_NewTweet_Button"], [data-testid="toolBar"] button')),
